      ...
      <div className="w-full max-w-[980px] h-full">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className=" bg-white border border-[#B0B0B0] rounded-full flex items-center justify-center py-3 px-2">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="bg-[#F9FDFF] rounded-3xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] text-[#34C759] text-xl  p-2 flex items-center justify-between w-[230px] h-[74px]">
            <h4 className="w-[60%]">Total App Users</h4>
            <p>18,420</p>
          </div>

          {/* 2nd card - Active users */}
          <div className="bg-[#F9FDFF] rounded-3xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] text-[#1D7BBB] text-xl  p-2 flex items-center justify-between w-[230px] h-[74px]">
            <h4 className="w-[60%]">Active Users (Today)</h4>
            <p>18,420</p>
          </div>

          {/* 3rd card - App Installs  */}
          <div className="bg-[#F9FDFF] rounded-3xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] text-[#8A38F5] text-xl  p-2 flex items-center justify-between w-[230px] h-[74px]">
            <h4 className="w-[40%]">App Installs</h4>
            <p>27,940</p>
          </div>

          {/*  4th card - New Users */}
          <div className="bg-[#F9FDFF] rounded-3xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] text-[#FF7049] text-xl  p-2 flex items-center justify-between w-[230px] h-[74px]">
