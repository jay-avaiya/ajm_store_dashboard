      ...
      <div className="relative w-full max-w-[980px] h-full">
        ...
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center gap-x-3">
            ...
            <span className="text-3xl">Inventory Tracking Management</span>
          </div>
        ...
        {isEdit && (
          <div className="absolute z-50 top-1/5 -right-40 w-full max-w-[290px] flex flex-col items-center bg-white rounded-3xl shadow-[0_4px_13px_0_rgba(0,0,0,0.25)] py-2">
